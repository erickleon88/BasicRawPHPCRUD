...
if(!empty($_POST['idx'])&&!empty($_POST['user'])&&!empty($_POST['name'])&&!empty($_POST['sex'])
...
&&!empty($_POST['comp'])&&!empty($_POST['credit'])){
    ...
    //Query a la db
    $query = "UPDATE `tblusuarios` SET usuario = '$user', nombre= '$name', sexo= '$sex', nivel= '$level', email= '$email', telefono= '$phone', marca= '$brand', compañia= '$comp', saldo= '$credit', activo= '$status' WHERE idx= '$id'";
